   ...
   switch(mode)
     {
      ...
      case TIZEN_KEYROUTER_MODE_PICTUREOFF:
         keylist_ptr = krt->HardKeys[key].pictureoff_ptr;
         break;
   ...
   switch(mode)
     {
      ...
      case TIZEN_KEYROUTER_MODE_PICTUREOFF:
         krt->HardKeys[key].pictureoff_ptr = eina_list_prepend(krt->HardKeys[key].pictureoff_ptr, new_keyptr);
         break;
   ...
   switch (mode)
     {
      ...
      case TIZEN_KEYROUTER_MODE_PICTUREOFF:            str = "Pictureoff";            break;
   ...
   switch (mode)
     {
        ...
        case TIZEN_KEYROUTER_MODE_PICTUREOFF:                list = &krt->HardKeys[key].pictureoff_ptr;  break;
        default: break;
     }
